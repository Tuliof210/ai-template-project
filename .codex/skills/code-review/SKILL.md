...
- **Project rules** — read `meta/rules/*` or `AGENTS.md` if they exist, but only the parts likely to apply. If they don't exist, proceed without them and don't mention it.
