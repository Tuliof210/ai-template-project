...
| Path | Purpose |
|------|---------|
| `.Codex/skills/` | Codex skill definitions (bootstrap, spec-write, spec-run, spec-fix, code-review, frontend, choose-model, design-system) |
...
| `meta/models.md` | Model selection guide (Codex + Codex tiers, in Portuguese) |
